...
const ProductPage = () => {
  ...
  const enableCartBtn = () => {
    if(!addToCartBtn.current)
      return;
    addToCartBtn.current.style.backgroundColor = orgDetails[0].theme_color;
    ...
    <div className={`pt-[4rem] md:pt-[6rem] w-[96vw] ${isZoomEnabled ? '' : 'touch-pan-y'}`}>
      ...
      <div className="m-auto max-w-screen-lg">
        <div className="w-full px-5">
          <div className="text-left"><span className="ml-1 mr-2 text-lg" style={{fontFamily : `${orgDetails[0].font}`}}>Description Box</span><InfoButton link="/information/prompt" /></div>
          <textarea
            ref={promptBoxRef}
            name="prompt"
            value={localPrompt}
            ...
            rows="2"
            style={{fontFamily : `${orgDetails[0].font}`, overflowY: 'auto', height: '70px',fontSize: '15px'}}
