...
export default function ContactPage(){
    ...
    return (
        <div className="flex flex-col w-10/12 h-full" style={{}}>
            ...
            <div className='flex flex-col text-white h-24 text-5xl text-center justify-center' style={{fontFamily : `${orgDetails.font}`, backgroundColor: `${orgDetails.theme_color}`}}>
                CONTACT
            </div>
            <div className="h-8"></div>
            <div className="flex flex-col md:flex-row space-y-10 md:space-x-10">
                <div className="md:w-8/12 border-2 border-neutral-300 px-5">
                    <div className="h-8"></div>
                    <h1 className="text-4xl mb-2" style={{fontFamily : `${orgDetails.font}`}}>Contact us</h1>
                    <p className="text-gray-500 text-lg" style={{fontFamily : `${orgDetails.font}`}}>Reach out to us with your ideas, feedback, or inquiries! At Drophouse, your voice fuels our innovation. Connect with us through email or social media. Let's make your apparel dreams a reality together. Your journey of expression starts here.</p>
                    <div className=''>
                        <div className='flex flex-col space-y-2'>
                            <h2 className='text-start' style={{fontFamily : `${orgDetails.font}`}}>NAME</h2>
                            <ClassInput placeholder="Enter your name" onChange={setName} />

                            <h2 className='text-start' style={{fontFamily : `${orgDetails.font}`}}>EMAIL ADDRESS</h2>
                            <ClassInput placeholder="Enter your email" onChange={setEmail} />

                            <h2 className='text-start' style={{fontFamily : `${orgDetails.font}`}}>Message</h2>
                ...
                <div className="w-full md:w-4/12">
                    <div className='w-full'>
                        <h2 className="text-start text-gray-900 text-lg" style={{fontFamily : `${orgDetails.font}`}}>OUR OFFICE</h2>
                        <p className="text-start text-gray-500 text-lg" style={{fontFamily : `${orgDetails.font}`}}>415 N CASS AVE WESTMONT, IL, 60559</p>
                    </div>
                    <div className="h-6"></div>
                    <div className='w-full'>
                        <h2 className="text-start text-gray-900 text-lg" style={{fontFamily : `${orgDetails.font}`}}>CONTACT</h2>
                        <p className="text-start text-gray-500 text-lg" style={{fontFamily : `${orgDetails.font}`}}>{DrophouseContactEmail}</p>
                        <p className="text-start text-gray-500 text-lg" style={{fontFamily : `${orgDetails.font}`}}>+1 (312) 544-9842</p>
                    </div>
                </div>
            </div>
        </div>
